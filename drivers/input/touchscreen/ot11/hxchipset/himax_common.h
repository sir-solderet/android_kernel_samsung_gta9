...
/*Tab A9 code for SR-AX6739A-01-260 by wenghailong at 20230510 start*/
#include "touch_feature.h"
#define HIMAX_NAME_LEN 64
/*Tab A9 code for SR-AX6739A-01-260 by wenghailong at 20230510 end*/
...
#define CONFIG_TOUCHSCREEN_HIMAX_IC_HX83102
#define CONFIG_TOUCHSCREEN_HIMAX_INSPECT
#define CONFIG_TOUCHSCREEN_HIMAX_INCELL
#define CONFIG_TOUCHSCREEN_HIMAX_DEBUG

#define HIMAX_DRIVER_VER "2.1.0.19_OT9_01"
...
/*Tab A9 code for SR-AX6739A-01-271 by suyurui at 20230427 start*/
#if IS_ENABLED(CONFIG_FACTORY_TEST)
#define HX_RW_FILE
#endif
/*Tab A9 code for SR-AX6739A-01-271 by suyurui at 20230427 end*/
...
/*Tab A9 code for SR-AX6739A-01-280 by suyurui at 20230518 start*/
#define HX_CONTAINER_SPEED_UP
/*Tab A9 code for SR-AX6739A-01-280 by suyurui at 20230518 end*/
/*#define HX_OPT_HW_CRC //hx83108a*/
#ifdef HX_OPT_HW_CRC
struct zf_opt_crc;
...
#define BOOT_UPGRADE_FWNAME "hx83102e_gx_hsd_firmware.bin"
#if defined(HX_ZERO_FLASH)
extern uint8_t *g_update_cfg_buf;
extern char *g_fw_mp_upgrade_name;
#define MPAP_FWNAME "himax_gx_hsd_mpfw.bin"
#endif
#endif
...
#if defined(HX_SMART_WAKEUP)
/*Tab A9 code for SR-AX6739A-01-261 by wenghailong at 20230510 start*/
#define HX_KEY_DOUBLE_CLICK KEY_WAKEUP
/*Tab A9 code for SR-AX6739A-01-261 by wenghailong at 20230510 end*/
...
struct himax_ts_data {
    ...
    char chip_name[30];
    /*Tab A9 code for SR-AX6739A-01-260 by wenghailong at 20230510 start*/
    char himax_nomalfw_rq_name[HIMAX_NAME_LEN];
    char himax_mpfw_rq_name[HIMAX_NAME_LEN];
    char himax_csv_name[HIMAX_NAME_LEN];
    char module_name[HIMAX_NAME_LEN];
    /*Tab A9 code for SR-AX6739A-01-260 by wenghailong at 20230510 end*/
